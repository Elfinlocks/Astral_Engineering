...
<recipetype:immersiveengineering:arc_furnace>.addRecipe("arc_furnace_elementium", <item:mythicbotany:elementium_ore>, 100, 51200, [<item:botania:elementium_ingot>], <item:immersiveengineering:slag>);
