...
<recipetype:immersiveengineering:arc_furnace>.addRecipe("arc_furnace_steel", <item:minecraft:iron_ingot>, [<item:immersiveengineering:dust_coke>], 100, 12000, [<item:immersiveengineering:ingot_steel>], <item:immersiveengineering:slag>);
