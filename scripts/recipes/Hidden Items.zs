...
mods.jei.JEI.hideItem(<item:bountifulbaubles:broken_heart>);
mods.jei.JEI.hideItem(<item:immersiveengineering:wire_copper>);
mods.jei.JEI.hideItem(<item:pamhc2foodcore:saltitem>);
mods.jei.JEI.hideItem(<item:kubejs:electrolysis_controller>);
mods.jei.JEI.hideItem(<item:thermal:dynamo_stirling>);
mods.jei.JEI.hideItem(<item:thermal:dynamo_numismatic>);
...
mods.jei.JEI.hideItem(<item:tardis:cinnabar>);
mods.jei.JEI.hideItem(<item:mekanism:ingot_steel>);
mods.jei.JEI.hideItem(<item:libvulpes:ingotsteel>);
mods.jei.JEI.hideItem(<item:libvulpes:ingotcopper>);
mods.jei.JEI.hideItem(<item:libvulpes:ingotaluminum>);
mods.jei.JEI.hideItem(<item:mekanism:ingot_bronze>);
mods.jei.JEI.hideItem(<item:libvulpes:ingottin>);
mods.jei.JEI.hideItem(<item:thermal:constantan_ingot>);

// Hiding dupe metal blocks

mods.jei.JEI.hideItem(<item:libvulpes:blocksteel>);
mods.jei.JEI.hideItem(<item:mekanism:block_steel>);
...
mods.jei.JEI.hideItem(<item:eidolon:lead_block>);
...
mods.jei.JEI.hideItem(<item:thermal:constantan_block>);
...
mods.jei.JEI.hideItem(<item:mekanism:nugget_steel>);
...
mods.jei.JEI.hideItem(<item:thermal:constantan_nugget>);
...
mods.jei.JEI.hideItem(<item:mekanism:dust_steel>);
...
mods.jei.JEI.hideItem(<item:thermal:constantan_dust>);
mods.jei.JEI.hideItem(<item:createaddition:diamond_grit>);