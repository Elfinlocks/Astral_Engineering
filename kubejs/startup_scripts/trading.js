...
onEvent('item.registry', event => {
	...
	let profession = (name, c1, c2, transactions) => {
		...
		// event.create(`profession_card_${id}`)
			...
			// .displayName(`${name} License`)
			// .unstackable()
		event.create('profession_card_construction').displayName('Construction License')
			.unstackable()
			.texture("kubejs:item/construction_token")
		event.create('profession_card_cooking').displayName('Cooking License')
			.unstackable()
			.texture("kubejs:item/cooking_token")
		event.create('profession_card_farming').displayName('Farming License')
			.unstackable()
			.texture("kubejs:item/farming_token")
		event.create('profession_card_fishing').displayName('Fishing License')
			.unstackable()
			.texture("kubejs:item/fishing_token")
		event.create('profession_card_mining').displayName('Mining License')
			.unstackable()
			.texture("kubejs:item/mining_token")
	...
	profession("Construction", 0xD0AF84, 0x966C3B, [
