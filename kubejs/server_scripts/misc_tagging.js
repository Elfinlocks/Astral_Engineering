...
events.listen('item.tags', function (event) {
	...
	event.get('thermal:crafting/dies')
		.add('kubejs:press_circuit_die')
		.add('kubejs:cooking_token')
		.add('kubejs:farming_token')
		.add('kubejs:fishing_token')
		.add('kubejs:mining_token')
		.add('kubejs:slayer_token')
		.add('kubejs:smithing_token')
